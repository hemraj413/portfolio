...
export default function Home() {
  ...
  return (
    <div className="bg-gray-300 min-w-[100vw] max-h-[100vh] container overflow-hidden">
        ...
        <h1 className=" md:text-5xl text-2xl font-mono sm:w-full h-[10vh] sm:bg-purple-800 xl:px-5 sm:flex justify-center items-center sm:relative sm:top-0 sm:left-0 fixed top-4 left-4 w-fit text-black sm:text-white"><span>H</span><span className="text-red-600">13</span>.</h1>
        <ul className=" absolute top-1/2 px-2 -translate-y-1/2 xl:px-5 sm:w-auto sm:block flex justify-between items-center w-full  text-4xl">
          ...
          <li className={activeNav==='contact'?`text-black`:'text-white'} onClick={()=>handleNavClick('contact')}><GrContact/></li>
        </ul>
